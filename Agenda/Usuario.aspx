<%@ Page Title="" Language="C#" MasterPageFile="~/MarterPaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="Usuario.aspx.cs" Inherits="Agenda.Usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Lista de Usuarios"></asp:Label>
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="SqlDataSourceUsuario" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [usuario] WHERE [email] = @email" InsertCommand="INSERT INTO [usuario] ([email], [nome], [senha]) VALUES (@email, @nome, @senha)" OnInserted="SqlDataSourceUsuario_Inserted" OnUpdated="SqlDataSourceUsuario_Updated" SelectCommand="SELECT [email], [nome], [senha] FROM [usuario]" UpdateCommand="UPDATE [usuario] SET [nome] = @nome, [senha] = @senha WHERE [email] = @email">
        <DeleteParameters>
    ...
    <p class="auto-style1">
    <br />
    <asp:Label ID="lMsg" runat="server" Font-Bold="True" Font-Size="X-Large" Visible="False"></asp:Label>
</p>
</asp:Content>
